				...
				{vaccination.datesTaken.map((date, index) => (
					<li key={index} className="font-normal">
						<input
							...
							className="border border-gray-300 rounded-md p-2 mb-2"
						/>
						<button onClick={() => handleRemoveDate('datesTaken', vaccination.id, index)} className="bg-slate-200 border border-gray-300 rounded-md p-2 m-2">Remove Date</button>
					</li>
				))}
				...
				{vaccination.futureDates.map((date, index) => (
					<li key={index} className="font-normal">
						<input
							...
							className="border border-gray-300 rounded-md p-2 mb-2"
						/>
						<button onClick={() => handleRemoveDate('futureDates', vaccination.id, index)} className="bg-slate-200 border border-gray-300 rounded-md p-2 m-2">Remove Date</button>
					</li>
				))}

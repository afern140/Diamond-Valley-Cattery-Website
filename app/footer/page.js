...
const Footer = () => {
  return (
    <div className=" text-2xl border-t-2 border-[#eecbc7] dark:border-[#6f403a] text-black bg-[#9d5850] dark:bg-[#704f43] left-0 bottom-0 right-0">
        <div className="w-full h-10">
            ...
            <div className=" bg-[#9d5850] dark:bg-[#704f43] p-7">

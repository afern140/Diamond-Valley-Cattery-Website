...
export default function Page() {
	...
	return (
		<main className="relative text-black pb-16">
			...
			<div className="relative pt-20 flex pb-10">
					...
					{sortedLitters ? (
						sortedLitters.map((litter) => (
							<div className="flex flex-row drop-shadow-lg bg-navbar-body-1 rounded-xl m-5 p-5">
								...
								<div>
									<div className="m-4 p-4 bg-white rounded-xl drop-shadow-lg">
									...
									<div>
										{litter.completed ? (
											<div className="bg-white m-4 p-4 rounded-xl drop-shadow-lg space-y-2">
												<h2>Kittens:</h2>
												<div className="flex">
